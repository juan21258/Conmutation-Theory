...

{
  ...
  pinMode(47,OUTPUT);
  digitalWrite(47,0);
  lcd.begin(16,2);                     		//Define el LCD a utilizar 
  seg=0;  
  Timer1.initialize(10000);
  //1000000  		//define el tiempo de trabajo del timer a 1seg
  Timer1.attachInterrupt(chronometer); 		//habilita y llama la interrupcion por timer
  lcd.clear();
